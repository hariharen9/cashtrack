        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text(
                    'Changing the currency type will clear all past data and restart. Please back up your data if you need to.'),
              ],
            ),
          ),
          actions: <Widget>[
                          ...
                          onTap: () {
                            if (widget.amountController.text.isNotEmpty) {
                              if (!isNumeric(widget.amountController.text) ||
                                ...
                                _save(
                                    "dailyLimit", widget.numData["dailyLimit"]);
                              }
                            }
